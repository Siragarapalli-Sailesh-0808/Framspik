  ...
  const handleGetStarted = async () => {
    ...
    try {
      ...
      if (error.name === "NotAllowedError") {
        setErrorMessage("Camera permission was denied. Please update browser settings to enable camera access.");
      } else if (error.name === "NotFoundError" || error.name === "DevicesNotFoundError") {
        setErrorMessage("No webcam or video capture device was found on this system.");
      } else {
